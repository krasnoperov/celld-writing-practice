...
The application is also a compact example of running Durable Objects with [`celld`](https://github.com/denoland/celld). [How Durable Objects work](https://krasnoperov.me/posts/how-durable-objects-work) explains the model; [A writing agent with Durable Objects](https://krasnoperov.me/posts/a-writing-agent-with-durable-objects) shows it in use.
